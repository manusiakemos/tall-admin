    ...
    <tr
        ...
        {{
            $attributes->merge($customAttributes)
                ->class(['bg-white dark:bg-gray-700 text-gray-700 dark:text-white' => ($customAttributes['default'] ?? true) && $rowIndex % 2 === 0])
                ->class(['bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-white' => ($customAttributes['default'] ?? true) && $rowIndex % 2 !== 0])
