<x-app-layout>
    ...
    <div style="background: url('{{ asset('images/bg-glass.png') }}'); background-attachment: fixed; background-position: center; background-size: cover">
        <div
            class="px-3 min-h-screen min-w-screen flex flex-wrap justify-center items-center relative backdrop-filter backdrop-blur-3xl backdrop-sepia-0 bg-white/30 dark:bg-black/50 min-h-screen h-full w-full ">
            <div class="prose dark:prose-invert container mx-auto py-6">
