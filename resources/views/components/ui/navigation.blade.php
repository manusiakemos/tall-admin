        ...
        @role('super-admin')
            ...
            <x-ui.navigation-item session-active="user" link="{{ route('user') }}">
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                        <path fill="none" d="M0 0h24v24H0z" />
                        <path class="{{ session('active') != 'user' ? 'dark:fill-white' : 'fill-white' }}"
            ...
            <x-ui.navigation-item session-active="setting" link="{{ route('setting') }}">
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                        <path fill="none" d="M0 0h24v24H0z" />
                        <path class="{{ session('active') != 'setting' ? 'dark:fill-white' : 'fill-white' }}"
            ...
            <x-ui.navigation-dropdown session-expanded="utilities">
                ...
                <x-ui.navigation-item session-active="laravel-filemanager" link="{{ url('laravel-filemanager') }}">
                    File Manager
                </x-ui.navigation-item>
