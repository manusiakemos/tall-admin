<aside x-show="showSidebar"
       ...
       class="fixed md:w-60 hidden md:block z-10
              w-full h-screen inset-0 overflow-hidden flex flex-col
              dark:bg-gray-800 bg-gray-100"
       id="sidebar">
    {{-- top section --}}
    <div id="top" class="text-white w-full">
        <div class="p-6 flex">
            <a href="{{url('/home')}}"
               class="tracking-wide
                  w-full text-center
    ...
    <div id="middle" class="text-white w-full flex-grow overflow-auto">
    ...
    {{-- bottom section --}}
    <div id="bottom" class="h-32 text-white w-full absolute left-0 right-0 bottom-0 flex items-center">
        <a href="{{url('logout')}}"
