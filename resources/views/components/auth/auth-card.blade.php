<div class="md:grid md:grid-cols-2" style="background: url('{{ asset('images/bg-glass.png') }}')">
    <div class="hidden md:flex md:flex-col
                min-h-screen w-full bg-gray-900 dark:bg-gray-900
    ...
    <div
        ...
        <div class="bg-white/70 dark:bg-gray-900/30 flex flex-col w-full mx-12 px-12 py-6 rounded-3xl shadow-lg dark:shadow-primary-500 shadow-gray-100">
            <h5
