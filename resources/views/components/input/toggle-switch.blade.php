<div class="flex cursor-pointer"
    ...
    <div class="relative rounded-full w-12 h-6 transition duration-200 ease-linear"
         :class="toggle ? 'dark:bg-warning-400 bg-primary-400' : 'bg-gray-400'">
        <label for="toggle"
               ...
               :class="toggle ? 'translate-x-full dark:border-warning-400 border-primary-400' : 'translate-x-0 border-gray-400'"></label>
